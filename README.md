...
A live demo of the project is available at [https://bokepmasturbasi.pages.dev](https://bokepmasturbasi.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep mulus`)
...
```bash
git clone <repo-url> bokepmasturbasi
cd bokepmasturbasi
```
...
1. Fork the [repository](https://github.com/somisaldo7/bokepmasturbasi/fork) on GitHub.
